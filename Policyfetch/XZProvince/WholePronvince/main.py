...
class SZFFetcher:
    ...
    def loc_policy(self):
        ...
        params = {
            "code": "30e4960928e74a14a2c05439d100cfc0",
            "pageSize": 10,
            "searchWord": "通知",
            "siteId": 2,
            "type": 19,
        ...
        api_url = "http://www.xizang.gov.cn/igs/front/search.jhtml"
        ...
        for j in range(0, len(key_params)):
            ...
            while True:
                ...
                print("正在爬取第" + str(params["pageNumber"]) + "页，文件类型为" + params["searchWord"])
                for each_policy in preview_data["page"]["content"]:
                    try:
                        ...
                        if "content" not in each_policy:
                            continue
                        results = each_policy["content"]
    ...
    def insert_data(self, info: json, year: str, content: str):
        ...
        if "trs_time" in info:
            if info["trs_time"] is None or info["trs_time"] == "":
                ...
                pub_time = info["trs_time"][0:10]

        info_tuple = (info["title"], policy_id, publisher, file_number,
                      pub_time, complete_time, content, info["url"], publisher, "西藏")
